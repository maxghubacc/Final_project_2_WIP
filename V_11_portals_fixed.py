...
def main():
    ...
    while True:
        ...
        if state == "PLAYING":
            # Pause briefly after teleport so player can choose a direction
            if portal_pause_ticks == 0:
                ...
                if blocked:
                    ...
                    if portals_active and head_cell in portal_pairs:
                        ...
                        # pause movement and require new direction choice
                        direction = (0, 0)
                        pending_dir = (0, 0)
        ...
        # right side labels spaced so they never overlap MENU
        if current_level == KEY_LEVEL_INDEX:
