...
# ---------- Procedural Audio ----------
def make_tone(freq, duration, volume=0.4, wave_type="square", fade_ms=8):
...
def build_music_loop():
    # Simple moody retro dungeon loop
    # Notes around A minor / C major area
    melody = [
